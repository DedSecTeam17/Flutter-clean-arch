...
import 'package:tdd_tut/features/number_trivia/data/models/number_trivia_model.dart';
import 'package:tdd_tut/features/number_trivia/data/repositories/number_trivia_repository_impl.dart';
...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    test('should check if the device is online', () async {
      //arrange
      when(mockNetworkInfo.isConnected).thenAnswer((_) async => true);
      print(await mockNetworkInfo.isConnected);
    ...
    runTestsOnline(() {
      test(
        ...
        () async {
          ...
          // assert
          // verify we have data from data source
